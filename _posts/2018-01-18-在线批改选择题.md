...
categories: Ajax+php
tags: Ajax
description: 前几天，和好久不见的色鬼叙了叙旧，得知他正在做毕业设计，其中一个要实现的功能就是在线选择题批改，他说有点犯难，巧的是他正在学TP。正好我也学习了一个学期的TP，感觉这个功能还挺有趣的，就主动说帮忙写，其中碰到不少问题，不过最终还是解决了。
...
**question表**：![TIM截图20180118100240](/wArrest.github.io/assets/images\testdemo\TIM截图20180118100240.png)

user表：![TIM截图20180118100316](/wArrest.github.io/assets/images\testdemo\TIM截图20180118100316.png)

user-test表（存放对应用户，对应用户的十道题目，也就是保存用户的试卷表）![TIM截图20180118100339](/wArrest.github.io/assets/images/testdemo/TIM截图20180118100339.png)
...
![TIM截图20180118102026](/wArrest.github.io/assets/images/testdemo/TIM截图20180118102026.png)
...
![TIM截图20180118103439](/wArrest.github.io/assets/images/testdemo/TIM截图20180118103439.png)
